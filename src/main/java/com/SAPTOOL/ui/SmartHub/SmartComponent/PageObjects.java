...
public class PageObjects extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panelObjectControls.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Controls", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 16), new java.awt.Color(0, 204, 204))); // NOI18N

        rbLink.setBackground(new java.awt.Color(255, 255, 255));
        rbLink.setText("Link");

        rbRadioButton.setBackground(new java.awt.Color(255, 255, 255));
        rbRadioButton.setText("Radio button");

        rbEditBox.setBackground(new java.awt.Color(255, 255, 255));
        rbEditBox.setText("EditBox");

        rbText.setBackground(new java.awt.Color(255, 255, 255));
        rbText.setText("Text");

        rbButton.setBackground(new java.awt.Color(255, 255, 255));
        rbButton.setText("Button");

        rbCheckBox.setBackground(new java.awt.Color(255, 255, 255));
        rbCheckBox.setText("CheckBox");

        rbCombobox.setBackground(new java.awt.Color(255, 255, 255));
